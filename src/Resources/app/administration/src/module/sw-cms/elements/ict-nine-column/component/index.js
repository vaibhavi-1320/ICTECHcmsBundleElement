import template from './sw-cms-el-ict-nine-column.html.twig';
import './sw-cms-el-ict-nine-column.scss';
...
export default {
    ...
    methods: {
        ...
        syncSlotState() {
            ...
            slotElement.classList.add('sw-cms-slot--ict-nine-column');
            slotElement.classList.toggle('sw-cms-slot--ict-nine-column-placeholder', this.isPlaceholder);
        },
        ...
        clearSlotState() {
            ...
            slotElement.classList.remove('sw-cms-slot--ict-nine-column');
            slotElement.classList.remove('sw-cms-slot--ict-nine-column-placeholder');
        },
    },
};
