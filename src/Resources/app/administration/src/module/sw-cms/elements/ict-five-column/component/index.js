import template from './sw-cms-el-ict-five-column.html.twig';
import './sw-cms-el-ict-five-column.scss';
...
export default {
    ...
    methods: {
        ...
        syncSlotState() {
            ...
            slotElement.classList.add('sw-cms-slot--ict-five-column');
            slotElement.classList.toggle('sw-cms-slot--ict-five-column-placeholder', this.isPlaceholder);
        },
        ...
        clearSlotState() {
            ...
            slotElement.classList.remove('sw-cms-slot--ict-five-column');
            slotElement.classList.remove('sw-cms-slot--ict-five-column-placeholder');
        },
    },
};
